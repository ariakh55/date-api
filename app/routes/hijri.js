...
/**
 * @api {get} /api/hij/holidays/:fromMonth/:fromYear/:toMonth/:toYear?eventType=something Holidays
 * @apiName Holidays
 * @apiGroup Hijri
 * @apiVersion 1.0.0
...
/**
 * @api {get} /api/hij/events/:day/:month/:year?eventType=something Events
 * @apiName Events
 * @apiGroup Hijri
 * @apiVersion 1.0.0
