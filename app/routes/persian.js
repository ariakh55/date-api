 ...
 * @apiGroup Persian
 * @apiVersion 1.0.0
 * @apiDescription Get holidays of a Persian timespan.
 *
 ...
 */
router.get('/api/per/holidays/:fromMonth/:fromYear?/:toMonth/:toYear?', checkSchema({
  fromMonth: {
    in: ['params'],
 ...
 * @apiGroup Persian
 * @apiVersion 1.0.0
 * @apiDescription Get events of a Persian date.
 *
 ...
 * @apiError {String} msg Error message.
 */
router.get('/api/per/events/:day/:month/:year?', checkSchema({
  day: {
    in: ['params'],
